...
<head>
    ...
    <style>
        body {
            ...
            margin: 0;
            padding: 0;
            background-image: url('../images/pro1.jpeg'); /* Use a relevant image */
...
<header>
    ...
    <nav>
        <a href="/loginType"><i class="fas fa-sign-in-alt"></i> Login</a>
...
<footer>
        <p>&copy; 2024 Travel Connect.Designed with ❤ by our Team PT²</p>
</footer>
